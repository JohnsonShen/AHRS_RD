...
void UAC_Init(void)
{
    ...
    SYS->GPD_MFPL |= SYS_GPD_MFPL_PD0MFP_I2S1_MCLK |
...
uint16_t I2C_ReadWAU8822(uint8_t u8addr)
{
    ...
    /* Send register number and MSB of data */
    I2C_SET_DATA(I2C0, (uint8_t)(u8addr << 1));
    I2C_SET_CONTROL_REG(I2C0, I2C_CTL_SI);
    I2C_WAIT_READY(I2C0);
    ...
    /* Read data */
    u16data=(I2C_GET_DATA(I2C0)<<8)&0xFF00;
    I2C_SET_CONTROL_REG(I2C0, I2C_CTL_SI);
    I2C_WAIT_READY(I2C0);
		
		/* Read data */
    u16data|=I2C_GET_DATA(I2C0)&0xFF;
